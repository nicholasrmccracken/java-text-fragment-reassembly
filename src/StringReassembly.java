...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        /*
         * Return a concatenated string consisting of a substring of str2 with
         * the overlap removed added to the end of str1.
         */
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        /*
         * Initialize boolean which tracks if str is a substring of any string
         * already in the setStr to false, which assumes str is not a substring.
         */
        boolean isSubstring = false;

        /*
         * If str is a substring of any string in strSet, set the boolean
         * tracker to true.
         */
        ...
        /*
         * If str is a not substring of any string in strSet, remove any string
         * in strSetthat is a substring of str.
         */
        if (!isSubstring) {
            /*
             * Create a new set removedSubstrings of the same object type as
             * strSet and add any strings from strSet that are not a substring
             * of str to the new set.
             */
            Set<String> removedSubstrings = strSet.newInstance();
            for (String element : strSet) {
                if (!str.contains(element)) {
                    removedSubstrings.add(element);
                }
            }
            /*
             * Replace strSet with the new set that has no substrings of str
             * then add str to strSet.
             */
            strSet.transferFrom(removedSubstrings);
            strSet.add(str);
        }
    }
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        // Initialize set to store individual lines
        Set<String> individualLines = new Set1L<String>();

        /*
         * Add each individual line from the input file to the set as it's own
         * element until the end of the file is reached.
         */
        while (!input.atEOS()) {
            addToSetAvoidingSubstrings(individualLines, input.nextLine());
        }
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        /*
         * Check if each individual character of text is equal to '~' and print
         * a new line if so, otherwise print the character.
         */
